...
void LineHistory::ReInitDone() { history.pop_back(); }

std::string LineHistory::Edit(std::string currentBuffer,
                              MoveDirection direction, bool &success) {
...
void LineHistory::Clear() { history.clear(); }
